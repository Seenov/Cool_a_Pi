...
pcbmnt2dy = pcb[1]/2 - 3.5;
   ...
   translate([pcbmnt4x,pcbmnt4y,pcb[2]]) pcbstandoff();
     // control pcb push
    translate([pcbmnt2x,pcbmnt2y+9,2.4])cylinder(h=4,d=2);
    translate([pcbmnt2x-4,pcbmnt2y+5,2.4])cylinder(h=4,d=2);
